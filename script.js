...
const bookBtnArea = document.getElementById("book-now");
bookBtnArea.addEventListener('click', function () {
    const bookArea = document.getElementById("book-btn-area");
    bookArea.style.display = 'none';
})
bookBtn = document.getElementById("book-now");
bookBtnArea.addEventListener('click', function () {
    const bookArea = document.getElementById("output-area");
